...
export function WorkoutCard({
  ...
  return (
    <>
      {dayHeader ? (
        <div className="px-2 mb-3 sm:mb-4 mt-6 sm:mt-8 text-[11px] sm:text-xs font-bold text-muted-foreground/80 uppercase tracking-widest flex items-center gap-2">
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-border to-transparent" />
          <span className="truncate">{dayHeader}</span>
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-border to-transparent" />
        </div>
      ) : null}
      ...
      >
        <Card
          ...
          className={cn(
            "relative overflow-hidden border-2 border-border/60 rounded-2xl sm:rounded-3xl cursor-pointer",
            "backdrop-blur-xl bg-gradient-to-br from-card/95 via-card/90 to-card/95",
            "shadow-2xl transition-all duration-700 hover:shadow-[0_20px_70px_-15px_rgba(139,92,246,0.3)] hover:-translate-y-0.5",
            "supports-[backdrop-filter]:backdrop-blur-xl",
            "min-w-0",
            className
          )}
        >
          <CardHeader className="pb-4 sm:pb-5 pt-5 sm:pt-6 px-4 sm:px-6 space-y-4 sm:space-y-5">
            ...
            <div className="space-y-4 sm:space-y-5">
              <h3 className="text-lg sm:text-xl font-bold leading-tight line-clamp-2 text-balance bg-gradient-to-br from-foreground to-foreground/80 bg-clip-text text-transparent">
                {titulo}
              </h3>
              ...
              <div className="flex items-center gap-3 sm:gap-3.5 min-w-0">
                ...
                <div className="leading-tight min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 text-xs text-muted-foreground/80 mt-1 min-w-0">
              ...
              >
                <div
                  className="flex items-center justify-center gap-2 min-w-[84px] sm:min-w-[90px] px-2.5 sm:px-3 py-2.5 bg-gradient-to-br from-indigo-500/15 to-indigo-600/10 border-2 border-indigo-500/40 rounded-xl hover:from-indigo-500/25 hover:to-indigo-600/20 hover:border-indigo-500/60 hover:shadow-lg hover:shadow-indigo-500/20 hover:scale-105 transition-all duration-200"
                  role="listitem"
                >
                  ...
                  <span className="text-[11px] sm:text-xs text-indigo-600/80 dark:text-indigo-400/80 font-semibold">
                    Ejercicio{exercisesCount === 1 ? "" : "s"}
                  </span>
                </div>

                <div
                  className="flex items-center justify-center gap-2 min-w-[84px] sm:min-w-[90px] px-2.5 sm:px-3 py-2.5 bg-gradient-to-br from-blue-500/15 to-blue-600/10 border-2 border-blue-500/40 rounded-xl hover:from-blue-500/25 hover:to-blue-600/20 hover:border-blue-500/60 hover:shadow-lg hover:shadow-blue-500/20 hover:scale-105 transition-all duration-200"
                  role="listitem"
                >
                  ...
                  <span className="text-[11px] sm:text-xs text-blue-600/80 dark:text-blue-400/80 font-semibold">
                    Sets
                  </span>
                </div>

                <div
                  className="flex items-center justify-center gap-2 min-w-[84px] sm:min-w-[90px] px-2.5 sm:px-3 py-2.5 bg-gradient-to-br from-emerald-500/15 to-emerald-600/10 border-2 border-emerald-500/40 rounded-xl hover:from-emerald-500/25 hover:to-emerald-600/20 hover:border-emerald-500/60 hover:shadow-lg hover:shadow-emerald-500/20 hover:scale-105 transition-all duration-200"
                  role="listitem"
                >
                  ...
                  <span className="text-[11px] sm:text-xs text-emerald-600/80 dark:text-emerald-400/80 font-semibold">
                    {unit}
                  </span>
                </div>
                ...
                <div
                  className={cn(
                    "flex items-center justify-center gap-2 min-w-[84px] sm:min-w-[90px] px-3 py-2.5 rounded-xl border-2 font-semibold",
          ...
          <CardContent className="pt-0 pb-5 sm:pb-6 px-4 sm:px-6 space-y-4 sm:space-y-5">
            {!ejercicios || ejercicios.length === 0 ? (
              <div className="border-2 border-dashed border-border/80 bg-gradient-to-br from-muted/30 to-muted/10 p-5 sm:p-6 rounded-xl">
              ...
              <div className="space-y-3" role="list" aria-label="Ejercicios realizados">
                {ejercicios.map((ex, idx) => (
                  <div
                    ...
                    className="flex items-start gap-3 sm:gap-3.5 p-4 border-2 border-border/80 bg-gradient-to-br from-muted/20 via-muted/10 to-transparent hover:from-muted/40 hover:via-muted/30 hover:to-muted/20 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5 transition-all duration-200 group/exercise rounded-xl min-w-0"
                    role="listitem"
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="text-sm font-bold line-clamp-1 text-foreground mb-2">
                        {ex.nombre ?? "Ejercicio"}
                      </div>
                      <div className="flex flex-wrap items-center gap-2">
                        {ex.sets_done && (
                          <span className="inline-flex items-center justify-center gap-1 min-w-[66px] sm:min-w-[70px] px-2.5 py-1 bg-gradient-to-br from-blue-500/20 to-blue-600/10 border border-blue-500/40 rounded-lg text-[11px] sm:text-xs font-bold text-blue-700 dark:text-blue-300 shadow-sm">
                            {ex.sets_done} sets
                          </span>
                        )}
                        {ex.volume && (
                          <span className="inline-flex items-center justify-center gap-1 min-w-[66px] sm:min-w-[70px] px-2.5 py-1 bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 border border-emerald-500/40 rounded-lg text-[11px] sm:text-xs font-bold text-emerald-700 dark:text-emerald-300 shadow-sm">
            ...
            <div
              className="pt-4 sm:pt-5 border-t-2 border-border/80"
              data-no-open
              onClick={(e) => e.stopPropagation()}
              onMouseDown={(e) => e.stopPropagation()}
              onPointerDown={(e) => e.stopPropagation()}
