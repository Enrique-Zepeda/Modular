    ...
    <div className="isolate h-[100svh] supports-[height:100dvh]:h-[100dvh] overflow-y-auto overflow-x-hidden overscroll-y-contain touch-pan-y">
      <div className="mx-auto max-w-[min(100%,theme(spacing.7xl))] px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8 pb-8 pb-[env(safe-area-inset-bottom)]">
        ...
        <div className="relative overflow-hidden rounded-3xl border-2 border-primary/20 bg-gradient-to-br from-primary/15 via-purple-500/10 to-background p-5 sm:p-8 lg:p-10 shadow-2xl">
          ...
          <div className="absolute top-0 right-0 w-48 h-48 sm:w-72 sm:h-72 lg:w-96 lg:h-96 bg-gradient-to-br from-primary/20 to-purple-500/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none animate-pulse" />
          <div
            className="absolute bottom-0 left-0 w-40 h-40 sm:w-56 sm:h-56 lg:w-72 lg:h-72 bg-gradient-to-tr from-purple-500/15 to-primary/15 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none animate-pulse"
          ...
          <div className="relative space-y-4 sm:space-y-5">
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="relative">
                <Sparkles className="h-9 w-9 sm:h-12 sm:w-12 text-primary animate-pulse" />
                <div className="absolute inset-0 hidden sm:block text-purple-500 animate-ping opacity-20">
                  <Sparkles className="h-12 w-12" />
                </div>
              </div>
              <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-primary via-purple-600 to-primary bg-clip-text text-transparent">
                Recomendación de Rutina
              </h1>
            </div>

            <p className="text-sm sm:text-base lg:text-lg text-muted-foreground font-medium max-w-3xl leading-relaxed">
            ...
            <div className="flex flex-wrap gap-2.5 sm:gap-3 pt-1 sm:pt-2">
              <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm">
                ...
                <span className="text-xs sm:text-sm font-semibold text-foreground">Recomendación Instantánea</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-purple-500/10 border border-purple-500/20 backdrop-blur-sm">
                ...
                <span className="text-xs sm:text-sm font-semibold text-foreground">Personalizado</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm">
                <TrendingUp className="h-4 w-4 text-primary" />
                <span className="text-xs sm:text-sm font-semibold text-foreground">Basado en sistema experto</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          <Card className="border-2 border-border/60 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:border-primary/30 bg-gradient-to-br from-background via-background to-primary/5 overflow-hidden">
            <CardHeader className="space-y-2 sm:space-y-3 pb-5 sm:pb-6 pt-6 sm:pt-8 px-4 sm:px-6 border-b border-border/40 bg-gradient-to-r from-primary/5 via-purple-500/5 to-transparent rounded-t-xl">
              <CardTitle className="flex items-center gap-2.5 sm:gap-3 text-lg sm:text-2xl font-bold text-foreground">
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                  ...
                  <div className="space-y-2.5 group">
                    ...
                    <Select value={objetivo} onValueChange={setObjetivo}>
                      <SelectTrigger className="h-11 sm:h-12 rounded-xl border-2 border-border/60 hover:border-primary/50 focus:border-primary transition-all duration-300 group-hover:shadow-md">
                  ...
                  {/* Edad */}
                  <div className="space-y-2.5 md:col-span-2 group">
                    <Label className="text-sm font-semibold text-foreground flex items-center gap-2">
                      <User className="h-4 w-4 text-primary" />
                      ¿Cuál es tu edad?
                    </Label>
                    <Input
                      ...
                      min="16"
                      max="90"
                      className="h-11 sm:h-12 rounded-xl border-2 border-border/60 hover:border-primary/50 focus:border-primary transition-all duration-300 group-hover:shadow-md"
                    />
                  </div>
                </div>
                ...
                <div className="pt-2 sm:pt-4 space-y-4">
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full h-12 sm:h-14 bg-gradient-to-r from-primary via-purple-600 to-primary hover:from-primary/90 hover:via-purple-600/90 hover:to-primary/90 text-primary-foreground font-bold text-sm sm:text-base shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group rounded-xl"
                  >
                  ...
                  {error && (
                    <div
                      className="p-3.5 sm:p-4 border-2 border-destructive/40 bg-destructive/10 rounded-xl flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300"
                      role="alert"
                      aria-live="polite"
                    >
          ...
          <div className="space-y-6">
              ...
              <Card className="border-2 border-primary/30 shadow-2xl bg-gradient-to-br from-background via-primary/5 to-purple-500/5 animate-in fade-in slide-in-from-right-5 duration-500 overflow-hidden">
                <CardContent className="p-8 sm:p-12 text-center">
                  <div className="flex flex-col items-center gap-5 sm:gap-6">
                    <div className="relative">
                      <Loader2 className="h-14 w-14 sm:h-20 sm:w-20 animate-spin text-primary" />
                      <div className="absolute inset-0 hidden sm:block text-purple-500 opacity-20 animate-ping">
                        <Loader2 className="h-20 w-20" />
                      </div>
                    </div>
                    <div className="space-y-2 sm:space-y-3">
                      <h3 className="text-xl sm:text-2xl font-bold text-foreground">Analizando tus datos...</h3>
                    ...
                    <div className="w-full max-w-xs space-y-2.5 sm:space-y-3 pt-2 sm:pt-4">
            ...
            {resultado && (
              <Card className="border-2 border-purple-600/40 shadow-2xl hover:shadow-3xl transition-all duration-500 bg-gradient-to-br from-background via-primary/5 to-purple-500/5 animate-in fade-in slide-in-from-right-5 duration-500 overflow-hidden">
                <CardHeader className="space-y-2 sm:space-y-3 pb-5 sm:pb-6 pt-6 sm:pt-8 px-4 sm:px-6 border-b border-border/40 bg-gradient-to-r from-primary/10 via-purple-500/10 to-transparent rounded-t-xl relative overflow-hidden">
                  ...
                  <CardTitle className="flex items-center gap-2.5 sm:gap-3 text-lg sm:text-2xl font-bold text-foreground relative">
                    <div className="p-2 rounded-xl bg-primary/20 border border-primary/30">
                ...
                <CardContent className="p-4 sm:p-6">
                  {loadingPrograma && (
                    <div className="text-center py-10 sm:py-12 space-y-5 sm:space-y-6">
                      <h3 className="text-2xl sm:text-3xl font-bold text-foreground bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent">
                        {resultado.replace(/_/g, " ")}
                      </h3>
                      <div className="flex items-center justify-center gap-2.5 sm:gap-3 text-primary">
                        <Loader2 className="h-5 w-5 sm:h-6 sm:w-6 animate-spin" />
                        <span className="text-sm sm:text-base font-medium">Cargando detalles y rutinas...</span>
                      </div>
                    </div>
                  )}

                  {errorPrograma && (
                    <div className="flex flex-col items-center justify-center gap-4 text-destructive py-10 sm:py-12 animate-in fade-in duration-300">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 sm:gap-4">
                          <div className="flex-1 space-y-2 sm:space-y-3">
                            <h2 className="text-2xl sm:text-4xl font-bold text-foreground leading-tight bg-gradient-to-r from-primary via-purple-600 to-primary bg-clip-text text-transparent">
                          ...
                          <Button
                            ...
                            disabled={isCloning}
                            size="lg"
                            className="w-full md:w-auto bg-gradient-to-r from-primary via-purple-600 to-primary hover:from-primary/90 hover:via-purple-600/90 hover:to-primary/90 text-primary-foreground font-bold flex items-center gap-2 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95 shrink-0 relative overflow-hidden group rounded-xl"
                      ...
                      <div className="space-y-4 sm:space-y-5">
                        <div className="space-y-1.5 sm:space-y-2">
                          <h3 className="text-xl sm:text-2xl font-bold text-foreground flex items-center gap-3">
                            <div className="h-7 sm:h-8 w-1 bg-gradient-to-b from-primary to-purple-600 rounded-full" />
                            Rutinas del Programa
                          </h3>
                          <div className="h-1 w-20 sm:w-24 bg-gradient-to-r from-primary to-purple-600 rounded-full" />
                        </div>
                          ...
                          {(programa.ProgramasRutinas ?? []).map((item: any, idx: number) => (
                            ...
                            >
                              <CardHeader className="pb-3 relative overflow-hidden">
                                ...
                                <CardTitle className="text-base sm:text-lg font-bold text-foreground flex items-center gap-3 relative">
                  ...
                  {!loadingPrograma && !errorPrograma && !programa && (
                    <div className="text-center py-12 sm:py-16 space-y-5 sm:space-y-6 animate-in fade-in duration-300">
                      <div className="p-5 sm:p-6 rounded-full bg-muted/50 border-2 border-border/40 w-fit mx-auto">
                        <AlertCircle className="h-14 w-14 sm:h-16 sm:w-16 text-muted-foreground" />
                      </div>
                      <div className="space-y-2.5 sm:space-y-3">
                        <p className="font-bold text-lg sm:text-xl text-foreground">
                          No se encontró el programa recomendado
                        </p>
